...
public class TestData {
    ...
    public static final TypeClass TYPECLASS2 = new TypeClass(2, "Truck", 1.5);
    public static final TypeClass TYPECLASS3 = new TypeClass(3, "Comfort", 2.5);
    ...
    public static final Region REGION1 = new Region(1, "Federal1", "County1", "City1", 1234L, "Location1", 1.0);
    ...
    public static final RegionDTO REGION_FOR_SAVE = new RegionDTO(4, "Federa4", "County4", "City4", 1237L, "Location4", 4.0);
